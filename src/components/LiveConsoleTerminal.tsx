...
export const LiveConsoleTerminal: React.FC<LiveConsoleTerminalProps> = ({
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-xl overflow-hidden shadow-2xl flex flex-col h-[320px] lg:h-[380px]">
      {/* Terminal Header */}
      <div className="bg-slate-900/90 px-3.5 py-2 border-b border-slate-800 flex items-center justify-between gap-2 text-xs">
        <div className="flex items-center gap-2 font-mono text-slate-300">
          <Terminal className="w-4 h-4 text-cyan-400" />
          <span className="font-semibold text-white">LIVE PROTOCOL CONSOLE</span>
          <span className="text-slate-500 text-[11px]">| WinUSB / Direct COM / Sahara Buffer</span>
          {isExecuting && (
